...
raise unless valid?(111_111)
raise if valid?(223_450)
raise if valid?(123_789)

puts (range[0]..range[1]).count { |i| valid?(i) }

raise unless valid?(112_233, part2: true)
raise if valid?(123_444, part2: true)
raise unless valid?(111_122, part2: true)
