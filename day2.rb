...
raise 'Bad example5' unless gravity_assist?(input, 4_930_687, 12, 2)
...
example6 = all_pairs do |noun, verb|
  gravity_assist?(input, 4_930_687, noun, verb)
end
raise 'Bad example6' unless example6 == 1202

puts "Part 2: #{all_pairs { |noun, verb| gravity_assist?(input, 19_690_720, noun, verb) }}"
